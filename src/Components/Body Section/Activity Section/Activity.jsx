       ...
       <div className="secContainer grid">
        <div className="singleCustomer flex">
          ...
          <div className="customerDetails">
            <span className="name">Hasan Qurbanov</span>
        ...
        <div className="singleCustomer flex">
          ...
          <div className="customerDetails">
            <span className="name">Amil Mammadov</span>
            <small>Ordered a new product</small>
          </div>
          <div className="duration">
            2 min ago
        ...
        <div className="singleCustomer flex">
          ...
          <div className="customerDetails">
            <span className="name">Ramin Majidli</span>
            <small>Ordered a new product</small>
          </div>
          <div className="duration">
            3 min ago
        ...
        <div className="singleCustomer flex">
          ...
          <div className="customerDetails">
            <span className="name">Kamran Nuriyev</span>
            <small>Ordered a new product</small>
          </div>
          <div className="duration">
            4 min ago
        ...
        <div className="singleCustomer flex">
          ...
          <div className="customerDetails">
            <span className="name">Anar Yagubov</span>
            <small>Ordered a new product</small>
          </div>
          <div className="duration">
            5 min ago
